    ...
    public partial class laptop1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_tables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoponName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoponEvent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoponDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Coponvalue = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_tables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location_map = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Warehous_hours = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RAM_Memory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Storage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Graphics_Card = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Battery_Life = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cart_tableId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cart_items_Cart_tables_Cart_tableId",
                        column: x => x.Cart_tableId,
                        principalTable: "Cart_tables",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Warehouse_pro_qus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Warehouse_pro_qus_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Warehouse_pro_qus_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cart_items_Cart_tableId",
                table: "Cart_items",
                column: "Cart_tableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouse_pro_qus_ProductId",
                table: "Warehouse_pro_qus",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Warehouse_pro_qus_WarehouseId",
                table: "Warehouse_pro_qus",
                column: "WarehouseId");
        }
