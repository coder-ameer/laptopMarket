...
namespace laptopMarket.Migrations
{
    ...
    partial class laptopMarketContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("laptopMarket.Model.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("laptopMarket.Model.Cart_table", b =>
                {
                    b.HasOne("laptopMarket.Model.AppUser", "appuser")
                        .WithMany()
            ...
            modelBuilder.Entity("laptopMarket.Model.OrderItem", b =>
                {
                    b.HasOne("laptopMarket.Model.Order_table", null)
                        .WithMany("OrderItem")
                        .HasForeignKey("Order_tableId");
